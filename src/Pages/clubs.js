      ...
      <div className="container">
        ...
        <div className={toggleState === 1 ? "content  active-content" : "content"}>
          <div className="row " style={{ marginBottom: '60px' }}>
            <div className="col-5">
              <p className=""><img src="/static_img/esd-logo.png" /></p>
              ...
              <p className="justify-text" style={{ fontSize: "20px", fontWeight: "500" }}>
                ...
                of a functional & reliable integrated circuits.<br></br>
                Along with this it also includes PCB Designing where students learn
                design and simulate electrical systems, from simple circuits to complex electronics.
                Students improve electromech anical design with true electrical and mechanical
        ...
        <div className={toggleState === 2 ? "content  active-content" : "content"}>
          <div className="row " style={{ marginBottom: '60px' }}>
            <div className="col-5">
              <p className=""><img src="/static_img/iot-logo.png" /></p>
        ...
        <div className={toggleState === 3 ? "content  active-content" : "content"}>
          <div className="row " style={{ marginBottom: '40px' }}>
            <div className="col-5">
              <p className=""><img src="/static_img/cns-logo.png" /></p>
            ...
            <div className="col-7">
              <div className="row">
                <div className="imgcard col"><img src="/static_img/cns-img52.png" style={{ width: "45vw", height: "60vh", marginTop: "4vh", marginLeft: "2vw" }} /></div>
